...
const Index = () => {
    return (
        <div className="min-h-screen bg-background overflow-x-hidden">
            {/* Interactive Header */}
            <motion.header initial={{y: -100, opacity: 0}} animate={{y: 0, opacity: 1}} transition={{type: "spring", stiffness: 300, damping: 30}} className="sticky top-0 z-50 backdrop-blur-xl bg-background/80 border-b border-border shadow-sm">
                <div className="container flex items-center justify-between py-3">
                    ...
                    <nav className="hidden md:flex items-center gap-1 bg-muted/50 px-4 py-1.5 rounded-full border border-border/50">
                        ...
                        <a href="#map" className="px-4 py-2 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-background rounded-full transition-all">
                            Карта
                        </a>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {/* Interactive User Dropdown instead of a static 'Профил' link */}
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="w-56 mt-2 rounded-xl shadow-xl border-border/50">
                                <DropdownMenuLabel className="p-3">
                                    <div className="flex flex-col space-y-1">
                                        <p className="text-sm font-medium leading-none">Твоят Профил</p>
                                        <p className="text-xs leading-none text-muted-foreground">donor@burgas.bg</p>
                                    </div>
                                </DropdownMenuLabel>
                                ...
                                <DropdownMenuSeparator />
                                <DropdownMenuItem className="p-2 cursor-pointer text-destructive focus:bg-destructive/10 focus:text-destructive">
            ...
            <footer className="border-t border-border">
                <div className="container py-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
                    <div className="flex items-center gap-2">
                        ...
                        <span>Пулсът на Доброто · Бургас 2026</span>
                    </div>

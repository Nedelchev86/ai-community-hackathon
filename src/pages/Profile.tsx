            ...
            <main className="container py-12 max-w-4xl space-y-8">
                ...
                <Card className="p-8 border-2 shadow-soft">
                    <div className="flex flex-col sm:flex-row items-center gap-6">
                        <div className="w-24 h-24 rounded-full bg-gradient-primary grid place-items-center text-4xl font-bold text-primary-foreground shadow-soft">Т</div>
                ...
                <Card className="p-8 border-2">
                    ...
                    <div className="flex items-end gap-4 mb-4">
                        <span className="text-6xl font-bold bg-gradient-primary bg-clip-text text-transparent">{overall.toFixed(1)}</span>
                ...
                <div>
                    ...
                    <div className="space-y-3">
                        {reviews.length === 0 && <Card className="p-6 border-2 text-center text-muted-foreground">Все още няма отзиви.</Card>}
                        {reviews.map((r, i) => (
